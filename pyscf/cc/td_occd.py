...
def ao2mo(hao, fao, eri_ao, mo_coeff):
    ...
    h = einsum('uv,up,vq->pq',hao,mo_coeff.conj(),mo_coeff)
    h = sort1((h,h))

    f = einsum('uv,up,vq->pq',fao,mo_coeff.conj(),mo_coeff)
    f = sort1((f,f))
